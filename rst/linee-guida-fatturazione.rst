...
-  Al fine di limitare la possibilità di errore in fase di caricamento ed invio della fattura si consiglia di utilizzare il portale web per la fatturazione elettronica disponibile gratuitamente all’indirizzo: `http://ivaservizi.agenziaentrate.gov.it/ <http://ivaservizi.agenziaentrate.gov.it/>`__
...
-  Codice Valore: **Inserire esclusivamente il codice del buono (sensibile alla differenza tra caratteri maiuscoli e minuscoli) senza ulteriori valori (come riportato nella successiva immagine).**\ Il campo è obbligatorio al fine di ottenere il rimborso per la fattura. Attenzione: alcuni software potrebbero riportare campi nominati diversamente. **NB:**. Per prevenire il rischio di errore suggeriamo di inserire i codici dei buoni attraverso le funzionalità di copia/incolla direttamente dal portale.
...
-  IBAN: Inserire IBAN es. IT0000000000000000. **Attenzione**: L’omissione di IBAN o la sua errata compilazione non è segnalata come errore dal sistema. Accertarsi di averlo compilato correttamente prima di inviare la fattura.
...
| <CodiceDestinatario>               | dell'amministrazione     | indicare: QGGT71           |
|                                    | dello stato              |                            |
|                                    | destinatario della       |                            |
|                                    | fattura, definito        |                            |
...
|                                    | obbligatorio             | Ministero dell'Istruzione, |
|                                    | contenente dati          | dell'Università            |
|                                    | relativi al              | e della Ricerca            |
|                                    | cessionario /            |                            |
|                                    | committente              |                            |
+------------------------------------+--------------------------+----------------------------+
...
| <CodiceFiscale>                    | Fiscale                  | 80185250588                |
+------------------------------------+--------------------------+----------------------------+
| 1.4.1.3 <Anagrafica>               | dati anagrafici          |                            |
|                                    | identificativi del       |                            |
|                                    | cessionario/committente  |                            |
+------------------------------------+--------------------------+----------------------------+
| 1.4.1.3.1                          | ditta, denominazione     | Ministero dell'Istruzione, |
| <Denominazione>                    | o ragione sociale        | dell'Università            |
|                                    | (ditta, impresa,         | e della Ricerca            |
|                                    | società, ente), da       |                            |
|                                    | valorizzare in           |                            |
|                                    | alternativa ai campi     |                            |
...
|                                    | 370/2000)                |                            |
+------------------------------------+--------------------------+----------------------------+
| 1.4.2.1 <Indirizzo>                | indirizzo della sede     | Viale Trastevere           |
|                                    | del cessionario /        |                            |
|                                    | committente (nome        |                            |
|                                    | della via, piazza        |                            |
|                                    | etc.)                    |                            |
+------------------------------------+--------------------------+----------------------------+
| 1.4.2.2                            | numero civico            | 17/a                       |
| <NumeroCivico>                     | riferito                 |                            |
|                                    | all'indirizzo (non       |                            |
|                                    | indicare se già          |                            |
|                                    | presente nel campo       |                            |
|                                    | indirizzo)               |                            |
+------------------------------------+--------------------------+----------------------------+
| 1.4.2.3 <CAP>                      | Codice Avviamento        | 00153                      |
|                                    | Postale                  |                            |
+------------------------------------+--------------------------+----------------------------+
...
|                                    | di più codifiche)        |                            |
+------------------------------------+--------------------------+----------------------------+
| 2.2.1.3.1                          | indica la tipologia      | valore ammesso:            |
| <CodiceTipo>                       | di codice articolo       | CARTADELDOCENTE            |
|                                    | (TARIC, CPV, EAN,        |                            |
|                                    | SSC, ...)                |                            |
+------------------------------------+--------------------------+----------------------------+
